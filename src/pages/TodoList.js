...
const TodoList = () => {
  ...
  const refreshAccessToken = useCallback(async () => {
    try {
      ...
      const response = await axios.post("https://todo-api-t7f7.onrender.com/refresh", {}, {
  ...
  const fetchTasks = useCallback(async () => {
    try {
      ...
      const response = await axios.get("https://todo-api-t7f7.onrender.com/tasks", {
        headers: {
  ...
  const addTask = async () => {
    try {
        ...
        const response = await axios.post(
            "https://todo-api-t7f7.onrender.com/tasks",
  ...
  const toggleTaskStatus = async (taskId, currentStatus) => {
    try {
        ...
        const response = await axios.put(
          `https://todo-api-t7f7.onrender.com/tasks/${taskId}`,
...
const clearAllTasks = async () => {
  try {
      ...
      await axios.delete("https://todo-api-t7f7.onrender.com/tasks/clear", {
  ...
  const deleteTask = async (taskId) => {
    try {
        ...
        const response = await fetch(`https://todo-api-t7f7.onrender.com/tasks/${taskId}`, {
            method: "DELETE",
            headers: {
                "Content-Type": "application/json",
                "Authorization": `Bearer ${token}`,
